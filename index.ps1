...
$User = Get-ADUser -Identity "cpink" -Properties Description
...
$User = Get-ADUser -Identity "cpink" -Properties Description | Select-Object -ExpandProperty Description | ConvertTo-Html -As List -Property Description -Fragment -PreContent "<h2>Operating System Information</h2>"
...
$Report = ConvertTo-HTML -Body "$ComputerName $User $ProcessInfo $BiosInfo $DiscInfo $ServicesInfo" -Head $header -Title "Computer Information Report" -PostContent "<p id='CreationDate'>Creation Date: $(Get-Date)</p>"

#The command below will generate the report to an HTML file
$Report | Out-File .\Basic-Computer-Information-Report.html

Start-Process .\Basic-Computer-Information-Report.html